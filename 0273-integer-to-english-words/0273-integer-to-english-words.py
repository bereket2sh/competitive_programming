class Solution:
    def numberToWords(self, num: int) -> str:
        ...
        def to_words(num):
            ...
            if num < 1000:
                return [under_twenty[num // 100], "Hundred"]  + to_words(num % 100)
        
            for power, chunk in enumerate(chunks):
                if num < 1000 **(power + 1):
                    remainder, quationt = num // 1000 ** power, num % 1000 ** power
                    return to_words(remainder) + [chunk] + to_words(quationt) 
